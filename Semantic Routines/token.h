...
# define YYTOKENTYPE
  enum yytokentype
  {
    ...
    TOKEN_PRINT = 260,             /* TOKEN_PRINT  */
    TOKEN_MATRIX = 261,            /* TOKEN_MATRIX  */
    ...
    TOKEN_SEMICOLON = 268,         /* TOKEN_SEMICOLON  */
    TOKEN_LPAREN = 269,            /* TOKEN_LPAREN  */
    TOKEN_RPAREN = 270,            /* TOKEN_RPAREN  */
    TOKEN_LBRACE = 271,            /* TOKEN_LBRACE  */
    TOKEN_RBRACE = 272,            /* TOKEN_RBRACE  */
    TOKEN_LBRACKET = 273,          /* TOKEN_LBRACKET  */
    TOKEN_RBRACKET = 274,          /* TOKEN_RBRACKET  */
    TOKEN_COMMA = 275,             /* TOKEN_COMMA  */
    TOKEN_NUMBER = 276,            /* TOKEN_NUMBER  */
    TOKEN_FLOAT_NUMBER = 277,      /* TOKEN_FLOAT_NUMBER  */
    TOKEN_IDENT = 278              /* TOKEN_IDENT  */
  };
